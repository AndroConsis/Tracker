...
struct CubeView: View {
    ...
    private let cubeWidth: CGFloat = 90
    ...
    private func getValueForFace(_ face: Int) -> String {
        ...
        switch face {
        case 0: return "\(dataStore.totalCount)"
        case 1: return "\(getWeeklyCount())"
        case 2: return "\(getMonthlyCount())"
        case 3: return "\(getYearlyCount())"
        default: return "\(dataStore.totalCount)"
        }
    }
